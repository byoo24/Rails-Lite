...
Rails. Download the project skeleton [here][skeleton].
...
"/i/love/app/academy" in the browser.  See an example [here](https://assets.aaonline.io/fullstack/rails/projects/rails_lite/love_app_academy.png).
...
* Run `bin/p04_session_server.rb` and open localhost:3000.  When you first load the page, it should look like [this](https://assets.aaonline.io/fullstack/rails/projects/rails_lite/localhost_one.png
).  
* Now refresh.  It should look like [this](https://assets.aaonline.io/fullstack/rails/projects/rails_lite/localhost_three.png
).  
* Refresh again.  It should look like [this](https://assets.aaonline.io/fullstack/rails/projects/rails_lite/localhost_five.png
).
